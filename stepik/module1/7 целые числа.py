...
# Решение задач
# Аннотация. Урок посвящен изучению работы с целыми числами. 
# Изучим основные операции, а также научимся преобразовывать строки в числа.
...
# print(num1)
# print(num2)
# Результатом выполнения такой программы будут числа 14 и 20. 
...
# s = '1992'
# year = int(s)
# Переменная s имеет строковый тип данных. 
# С помощью команды int(), мы преобразовали строку к целому числу и записали результат в переменную с именем year.  
...
# Следующий код тут не сработает:

# num1 = input()
# num2 = input()
# print(num1 + num2)
# Python считает, что в переменных num1 и num2 находится текст, поскольку команда input() по умолчанию считывает именно текст.
...
# Например, в языке C# переменная целого типа может принимать значения из диапазона [-2^{63}; \, 2^{63} - 1][−2 
# 63
#  ;2 
# 63
#  −1]. В Python реализована так называемая длинная арифметика, то есть, по сути, переменная целого типа не имеет ограничений.
