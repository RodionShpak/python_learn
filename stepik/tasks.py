...
# num = int(input())
# num2 = int(input())
# print('Квадрат суммы', num, 'и', num2, 'равен', ((num + num2) ** 2))
# print('Сумма квадратов', num, 'и', num2, 'равна', (num ** 2) + (num2 ** 2))
...
# // //  --------------------===================== Сonditions =====================--------------------
# Напишите программу, которая считывает целое положительное число n, n, n ∈ [1;9] и выводит значение числа n + nn + nnn

# Формат входных данных
# На вход программе подаётся одно целое положительное число n, n, n ∈ [1;9].
